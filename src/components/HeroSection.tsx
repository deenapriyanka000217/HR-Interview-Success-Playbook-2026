  ...
  return (
    <section className="relative bg-[#001B3D] text-white pt-6 pb-12 sm:pt-10 sm:pb-16 px-4 overflow-hidden border-b border-blue-900/50">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Top Trust Badge */}
        <div className="inline-flex items-center gap-2 bg-[#002B5C] border border-blue-400/30 text-blue-200 px-3.5 py-1.5 rounded-full text-xs sm:text-sm font-bold mb-5 shadow-sm">
          <Sparkles className="w-3.5 h-3.5 text-[#FFD700] animate-pulse" />
          <span className="text-[#FFD700] tracking-wider uppercase">HR CAREER & INTERVIEW PREPARATION GUIDE 2026</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-blue-100 text-sm sm:text-base lg:text-lg leading-relaxed max-w-2xl font-normal">
            ...
            <div className="space-y-2.5 pt-1">
              {HERO_BENEFITS.map((benefit, idx) => (
                <div key={idx} className="flex items-start gap-3 text-blue-100 text-xs sm:text-sm font-medium">
            ...
            {/* Pricing Box */}
            <div className="bg-[#002B5C] border border-blue-400/20 rounded-2xl p-4 sm:p-5 shadow-xl max-w-lg space-y-4">
              ...
              <div className="space-y-2.5 pt-1">
                ...
                <div className="flex items-center justify-between text-xs text-blue-200 px-1 pt-0.5">
